...
class MembersPage extends BasePage {
    constructor(page) {
        ...
        //Member 1
        this.member1FirstNameInput = page.locator('[name="presFirstName"]');
        this.member1LastNameInput = page.locator('[name="presLastName"]');
        this.member1Stret1Input = page.locator('[name="presStreet1"]');
        this.member1Stret2Input = page.locator('[name="presStreet2"]');
        this.member1CityInput = page.locator('[name="presCity"]');
        this.member1StateDropdown = page.locator('[name="presState"]');
        this.member1ZipCodeInput = page.locator('[name="presZip"]');
    ...
    async fillMembersInformation(presFirstName, presLastName, presStreet1, presStreet2, presCity, presState, presZip) {
